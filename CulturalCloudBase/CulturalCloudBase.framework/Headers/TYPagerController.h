...
- (void)pagerController:(TYPagerController *)pagerController scrollViewWillBeginDragging:(UIScrollView *)scrollView;
- (void)pagerController:(TYPagerController *)pagerController scrollViewDidEndDecelerating:(UIScrollView *)scrollView;
...
@property (nonatomic, assign, readonly) UIViewController *curController;
...
@property (nonatomic, assign) NSInteger defaultIndex; // default index
